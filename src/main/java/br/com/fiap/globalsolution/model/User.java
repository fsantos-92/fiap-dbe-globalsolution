...
public class User implements UserDetails {
    ...
    public User name(String name) {
        Assert.notNull(name, "Parâmetro nome é obrigatório");
        this.name = name;
        return this;
    }

    public User email(String email) {
        Assert.notNull(email, "Parâmetro email é obrigatório");
        this.email = email;
        return this;
    }
    ...
    public User password(String password) {
        Assert.notNull(password, "Parâmetro senha é obrigatório");
        this.password = password;
        return this;
    }

    public User withRole(Role role){
        Assert.notNull(role, "Parâmetro role é obrigatório");
        this.roles.add(role);
        return this;
    }
